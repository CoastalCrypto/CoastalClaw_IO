...
function ActivityTab() {
  return <div className="text-xs font-mono" style={{ color: '#4a6a8a' }}>Activity coming soon...</div>
}

function InsightsTab() {
  return <div className="text-xs font-mono" style={{ color: '#4a6a8a' }}>Insights coming soon...</div>
}

function ReceiptsTab() {
  return <div className="text-xs font-mono" style={{ color: '#4a6a8a' }}>Receipts coming soon...</div>
}

function SettingsTab(_: { onStatusChange: (s: any) => void }) {
  return <div className="text-xs font-mono" style={{ color: '#4a6a8a' }}>Settings coming soon...</div>
}
